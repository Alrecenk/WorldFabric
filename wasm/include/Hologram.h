...
class Hologram{
    public:
        ...
        void append(std::vector<float>& floats, std::vector<int>& ints, std::vector<byte>& bytes);

        // sets this hologram read from the given arrays starting at the given indices
        void setFrom(std::vector<float>& floats, std::vector<int>& ints, std::vector<byte>& bytes, int float_ptr, int int_ptr, int byte_ptr);

        Variant pack(std::vector<float>& floats, std::vector<int>& ints, std::vector<byte>& bytes);

        void unpack(Variant& data,std::vector<float>& floats, std::vector<int>& ints, std::vector<byte>& bytes);
