...
class KDNode {
  public:
    ...
    virtual void getCollisionCandidates(const KDNode::BoundingSphere& m, std::set<int>& candidates) = 0;
    ...
    std::set<int> getCollisionCandidates(const KDNode::BoundingSphere& m);
