...
class Timeline{
    ...
    public:
        ...
        std::unordered_map<int, TObject*> last_observed_ptr ;
        ...
        std::priority_queue<std::pair<double, std::shared_ptr<TEvent>>> getAllEventsToRun(glm::vec3 vantage, double time);
