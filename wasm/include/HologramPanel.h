...
class HologramPanel{
    public:
        ...
        HologramPanel(Variant& serialized);

        // sets this panel read from the given arrays starting at the given indices
        HologramPanel(std::vector<float>& floats, std::vector<int>& ints, std::vector<byte>& bytes, int float_ptr, int int_ptr, int byte_ptr);
...
#endif // #ifndef _HOLOGRAM_PANEL_H_